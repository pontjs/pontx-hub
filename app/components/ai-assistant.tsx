...
const copy = {
  zh: {
    ...
    empty: "描述你想实现的能力，我会定位对应接口，说明鉴权与费用，并生成可执行的 SDK 或 CLI 代码。",
    suggestions: [
  ...
  en: {
    ...
    empty: "Describe what you want to build. I’ll identify the endpoint, explain auth and pricing, and generate executable SDK or CLI code.",
    suggestions: [
